...
@section('title', 'Informatics Market | Checkout')
						...
						<div class="row">
							<div class="col-md-12">
								<div class="cart-detail">
									...
									<ul>
										<li>
											<span>Subtotal</span> <span>Rp 150.000,-</span>
											<ul>
												<li><span>1 x Product Name</span> <span>Rp 150.000,-</span></li>
												<li><span>1 x Product Name</span> <span>Rp 150.000,-</span></li>
											</ul>
										</li>
										<li><span>Shipping</span> <span>Rp 0,-</span></li>
										<li><span>Order Total</span> <span>Rp 300.000,-</span></li>
									</ul>
								</div>
						   </div>
